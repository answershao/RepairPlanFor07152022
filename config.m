function [DataSet, project_para] = config(project_para, file)
    ...
    DataSetPath = strcat('F:\\YuYining\\Code\\DataSet\\mpsplip_repair\\', 'j', num2str(num_j - 2), '\\', 'MP', num2str(num_j - 2), '_', num2str(L), '\\', 'mp', '_', 'j', num2str(num_j - 2), '_', 'a', num2str(L), '_', 'nr', num2str(file));
