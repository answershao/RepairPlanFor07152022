...
function [temp_variables, conflict_acts_info] = adjust_othertime_schedule(project_para, data_set, iter_variables, conflict_acts_info, performing_acts_infos, forward_set, need_global_activity, cpm, alpha, cycle, time)
    ...
    if ~isempty(cur_need_global_activity)
        ...
        for u = 1:size(L3, 1) % 每个顺序下的冲突活动列表  20
            ...
            [temp_variables, conflict_act_info] = adjust_othertime_allocate_resource(data_set, iter_variables, performing_acts_infos, L6, time);
