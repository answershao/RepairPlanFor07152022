...
project_para.timeoff_level = 2; % 请假时间系数
...
for cycle = 1:project_para.cycles
    ...
    for time = 1:project_para.T
        ...
        if isempty(leave_infos)
            [leave_infos, save_staff_leave_totaltime] = next_leave_infos(project_para, schedule_solution, timeoff, iter_variables_with_time, iter_allocated_variables_information, iter_allocated_acts_information, save_leave_time, save_staff_leave_totaltime);
        end
