        ...
        for RS = 0.25:0.25:0.75
            ...
            for alpha = 0:0.5:1
                ...
                for index_strategy = 1:3
                    ...
                    saved_path = strcat('F:\\YuYining\\Code\\OutputSet\\MS-DRCMPSP-StaffLeave\\rangen\\', num2str(L), '-10\\', num2str(OS), '-', num2str(RF), '-', num2str(RS), '-', strategy, num2str(alpha), '.mat');
